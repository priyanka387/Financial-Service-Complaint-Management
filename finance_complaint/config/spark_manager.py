from finance_complaint.constant.environment.variable_key import AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY

import os
from pyspark.sql import SparkSession
access_key_id = os.getenv(AWS_SECRET_ACCESS_KEY, )
...
spark_session = SparkSession.builder.master('local[*]').appName('finance_complaint') \
    ...
    .config('spark.jars.packages',"com.amazonaws:aws-java-sdk:19.0.2,org.apache.hadoop:hadoop-aws:3.2.2")\
    .getOrCreate()
    # 
